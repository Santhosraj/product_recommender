...
feature_list = np.array(pickle.load(open(r"D:\Santhosraj Machine learning\productrecommenderapp\embeddings.pkl","rb")))
filenames = pickle.load(open(r"D:\Santhosraj Machine learning\productrecommenderapp\filenames.pkl","rb"))
